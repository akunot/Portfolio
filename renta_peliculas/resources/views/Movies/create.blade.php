        ...
        <div class="container-md">
            ...
            <form action="{{ route('movies.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control w-50 mx-auto" id="description" name="description"></textarea>
                </div>
                <div class="mb-3">
                    <label for="year_release" class="form-label">Fecha de Lanzamiento</label>
                    <input type="date" class="form-control w-50 mx-auto" id="year_release" name="year_release" required>
                </div>
                <div class="mb-3">
                    <label for="status" class="form-label">Estado</label>
                    <input type="text" class="form-control w-50 mx-auto" id="status" name="status" required>
                </div>
                <div class="mb-3">
