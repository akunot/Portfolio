    ...
    <div class="container-md">
        ...
        <form action="{{ route('reviews.update', $reviews->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control w-50 mx-auto" id="comment" name="comment" required> {{$reviews-> comment}} </textarea>
            </div>
            <div class="mb-3">
                <label for="rating" class="form-label">Calificación</label>
                <input type="number" class="form-control w-50 mx-auto" id="rating" name="rating" min="1" max="5"  value= "{{$reviews-> rating}}" required>
            </div>
