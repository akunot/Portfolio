                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="{{route('actors.index')}}">Peliculas</a></li>
        ...
        <div class="container-md">
            ...
            <form action="{{ route('directors.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control w-50 mx-auto" id="date_birth" name="date_birth" required>
                </div>
                <div class="mb-3">
                    <label for="nationality" class="form-label">Nacionalidad del Director</label>
                    <input type="text" class="form-control w-50 mx-auto" id="nationality" name="nationality" required>
                </div>
                <div class="mb-3">
                    <label for="biography" class="form-label">Biografia</label>
                    <textarea class="form-control w-50 mx-auto" id="biography" name="biography"></textarea>
                </div>
                <div class="mb-3">
                    <label for="image" class="form-label">Imagen</label>
                    <input type="file" class="form-control w-50 mx-auto" id="image" name="image" required>
                </div>
