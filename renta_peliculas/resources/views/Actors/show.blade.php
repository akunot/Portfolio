...
<html lang="en">
    ...
    <body>
        ...
        <!-- Product sectionnnnnnnnnnnnnnnnnnnnnnnn-->
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src=" {{ asset('assets_actor/'. $actors->image)}}" alt="..." /></div>
                    <div class="col-md-6">
                        <h1 class="display-5 fw-bolder">{{$actors->name}}</h1>
                        <h5 class="display-5 fw-normal">Biografia del actor</h5>
                        <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium at dolorem quidem modi. Nam sequi consequatur obcaecati excepturi alias magni, accusamus eius blanditiis delectus ipsam minima ea iste laborum vero?</p>    
                        <a href="{{ route('actors.edit', $actors->id) }}" class="btn btn-primary">Editar</a>
                        <form action="{{ route('actors.destroy', $actors->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
        ...
        <div class="container px-4 px-lg-5 mt-5">
            <h2 class="fw-bolder mb-4 text-center">Peliculas relacionadas con {{$actors->name}}</h2>
            <br>
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            @foreach($actors->movies as $movies)
                <div class="col mb-5">
